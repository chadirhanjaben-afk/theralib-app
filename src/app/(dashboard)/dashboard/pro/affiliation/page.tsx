...
export default function ProAffiliationPage() {
  const { user } = useAuth();
    ...
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div>
        ...
        <p className="text-brand-blue-gray mt-1">
          Recommandez Theralib à vos confrères et gagnez des commissions sur leurs abonnements.
        </p>
      </div>
        ...
        {data?.referralCode ? (
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-xl p-4 mt-4">
              ...
              <ol className="text-sm text-brand-blue-gray space-y-1.5 list-decimal list-inside">
                <li>Partagez votre code ou lien avec vos confrères</li>
                <li>Ils s&apos;inscrivent sur Theralib avec votre code</li>
                <li>Vous recevez une commission sur leur premier abonnement</li>
              </ol>
            </div>
          </div>
        ) : (
          <div className="text-center py-6">
            <p className="text-brand-blue-gray mb-4">
              Générez votre code de parrainage pour commencer à recommander Theralib.
            </p>
            <button
